...
public class VelocityTemplateGenerator implements Generator {
    private static final org.apache.logging.log4j.Logger logger = LogManager.getFormatterLogger(VelocityTemplateGenerator.class.getName());
    ...
    public String doGenerate() {
        ...
        stringBuilder.append("</body>\n");
        stringBuilder.append("</html>\n");
        logger.info("VelocityTemplateGenerator : ", stringBuilder.toString());
