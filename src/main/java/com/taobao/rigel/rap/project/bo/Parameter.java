...
public class Parameter implements java.io.Serializable {
    ...
    private Set<Action> actionPerformanceList = new HashSet<Action>();
    ...
    public Set<Action> getActionPerformanceList() {
        return actionPerformanceList;
    }

    public void setActionPerformanceList(Set<Action> actionPerformanceList) {
        this.actionPerformanceList = actionPerformanceList;
    }
