...
public class Action implements java.io.Serializable {
    ...
    private Set<Parameter> performanceParameterList = new HashSet<Parameter>();
    ...
    //增加参数入库类型
    public void addParameternew(Parameter parameter, String Type) {
        if (Type.equals("request")) {
            ...
            getPerformanceParameterList().add(parameter);
            parameter.getActionPerformanceList().add(this);
        }else{
    ...
    //wuhaifeng 增加性能函数初始化
    public Set<Parameter> getPerformanceParameterList() {
        return performanceParameterList;
    }

    public void setPerformanceParameterList(Set<Parameter> performanceParameterList) {
    ...
    public List<Parameter> getPerformanceParameterListOrdered() {
        Set<Parameter> parameterList = getPerformanceParameterList();
        List<Parameter> parameterListOrdered = new ArrayList<Parameter>();
        parameterListOrdered.addAll(parameterList);
        Collections.sort(parameterListOrdered, new ParameterComparator());
        return parameterListOrdered;
    ...
    public String toString() {
        ...
        //wuhaifeng 重点，构造actionList，添加性能项
        stringBuilder.append("\"performanceParameterList\":");

        stringBuilder.append("[");
        iterator = getPerformanceParameterListOrdered().iterator();
        while (iterator.hasNext()) {
            stringBuilder.append(iterator.next());
            if (iterator.hasNext()) {
                stringBuilder.append(",");
    ...
    public String getPerformanceParameterListHTML() {
        return getParameterListHTML(performanceParameterList);
    }
