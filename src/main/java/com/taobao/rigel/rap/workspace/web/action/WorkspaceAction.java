...
public class WorkspaceAction extends ActionBase {
    ...
    public String checkIn() throws Exception {
        ...
        logger.info("ProjectData start : ", getProjectData());
        ...
        //关键点，projectData，如何添加性能数据
        //wuhaifeng 修改，待删除
        //project.setProjectData(projectData);
        checkIn.setProjectData(project
                .toString(Project.TO_STRING_TYPE.TO_PARAMETER));
        logger.info("ProjectData in : ", project
                .toString(Project.TO_STRING_TYPE.TO_PARAMETER));
        ...
        //wuhaifeng
        //此步入库,入库数据checkin中的projectdata和this中的projectdate不同
        ...
        logger.info("ProjectData : ", checkIn.getProjectData());
        ...
        if (notification.getUser().getId() != getCurUserId())
            getAccountMgr().addNotification(notification);
        logger.info("updateCache start......");
        projectMgr.updateCache(id);
        logger.info("checkin end......");
        return SUCCESS;
    }
    ...
    public String export() throws Exception {
        ...
        try {
            //wuhaifeng 加载export资源模板，具体加载方式暂时还不清楚
